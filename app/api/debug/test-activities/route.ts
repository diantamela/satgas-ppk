  ...
  try {
    ...
    return NextResponse.json({
      ...
      debug: {
        ...
        contactNotifications: contactNotifications.map((n: { id: string; title: string; createdAt: Date; relatedEntityType: string | null }) => ({
          id: n.id,
          title: n.title,
          createdAt: n.createdAt.toISOString(),
          relatedEntityType: n.relatedEntityType
        })),
        filteredNotifications: filteredNotifications.map((n: { id: string; title: string; createdAt: Date; relatedEntityType: string | null }) => ({
          id: n.id,
          title: n.title,
          createdAt: n.createdAt.toISOString(),
          relatedEntityType: n.relatedEntityType
